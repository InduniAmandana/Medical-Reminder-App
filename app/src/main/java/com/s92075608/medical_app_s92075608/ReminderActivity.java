...
// This class is to take the reminders from the user and insert them into the database
public class ReminderActivity extends AppCompatActivity {
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), MediRemember.class);                //this intent will be called once the setting alaram is completes
